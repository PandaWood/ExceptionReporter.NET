...
namespace SLSExceptionReporter
{
	...
	public class SLSExceptionReporter : UserControl
	{
		private Label lblAdvancedSource;
		private TabPage tpGeneral;
		private GroupBox grbStackTrace;
		private Label lblMessage;
		private GroupBox groupBox3;
		private Label lblGeneralType;
		private GroupBox groupBox1;
		private TextBox txtGeneralMessage;
		private Label lblPhone;
		private TabControl tcTabs;
		private Button cmdCopy;
		private TreeView tvwExceptions;
		private Label lblContactMessageBottom;
		private TreeView tvwSettings;
		private Button cmdSave;
		private GroupBox gbLineGeneral1;
		private TextBox txtAdvancedType;
		private Label lblRegion;
		private TextBox txtApplication;
		private TabPage tpExplanation;
		...
		private Label lblContactMessageTop;
		private TabPage tpContact;
		private TextBox txtMessage;
		private Label lblUsername;
		private TextBox txtMachine;
		private Label lblExplanation;
		private Label lblProcessingMessage;
		private TreeView tvwEnvironment;
		...
		private TextBox txtGeneralType;
		private PrintDocument printDocument1;
		private TabPage tpSettings;
		private TabPage tpEnvironment;
		private Label lblEmail;
		private Label lblAdvancedType;
		...
		private Label lblExceptionHeirarchy;
		...
		{
			var resources = new System.Resources.ResourceManager(typeof (SLSExceptionReporter));
			...
			this.lblContactMessageBottom.Text =
				"The information on this form describing the error and envrionment settings will b" +
		...
		private bool exceptionHeirarchyToString(StringWriter swWriter)
		{
			...
			while (current != null)
			{
				...
				swWriter.WriteLine("Exception Type: " + current.GetType());
		...
		public bool displayException(Exception ex)
		{
			...
			txtGeneralType.Text = (ex.GetType()).ToString();
			...
			addEnvironmentNode2(".Net Framework Version(s)", "Win32_Product", root, true,
			                    "WHERE Caption like 'Microsoft .Net Framework%'");
		...
		{
			var tnRoot = new TreeNode(e.GetType().ToString());
			tnRoot.Tag = "0";
		...
		private bool addEnvironmentNode2(String strCaption, String strClass, TreeNode parentNode, Boolean blnUseName,
		                                 String strWhere)
		{
			try
			{
				...
				foreach (ManagementObject mo in searcher.Get())
				{
					...
					{
						propertyNode = new TreeNode(iPropData.Name + ':' + Convert.ToString(iPropData.Value));
		...
		private void tvwEnvironment_AfterSelect(object sender, TreeViewEventArgs e)
		{
		}
		...
		private void txtGeneralType_TextChanged(object sender, EventArgs e)
		{
		}

		private void tvwExceptions_AfterSelect(object sender, TreeViewEventArgs e)
		{
		...
		private void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
		{
			...
			if (PageCount == 1)
			{
				...
				intCharactersLine = (int) (drawWidth/fSize.Width);
				intLinesPage = (int) (drawHeight/fSize.Height);
		...
		private void tpExplanation_Click(object sender, EventArgs e)
		{
		}

		private void tpEnvironment_Click(object sender, EventArgs e)
		{
		}
