...
namespace Test.ExceptionReporter
{
	...
	public class ExceptionReporterTest
	{
		...
		public void CanCreate_Referenced_Assemblies_String()
		{
			...
			string assemblyNames = ExceptionUtils.ReferencedAssembliesToString(dataAssembly);
		...
		{
			string assemblyNames = ExceptionUtils.ReferencedAssembliesToString(null);
		...
		{
			string hierarchyString = ExceptionUtils.ExceptionHierarchyToString(
