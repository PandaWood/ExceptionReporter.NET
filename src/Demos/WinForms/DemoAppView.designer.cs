namespace Demo.WinForms
{
    partial class DemoAppView
    {
        ...
        private void InitializeComponent()
        {
			...
			this.urlDefault.Text = "Show More/Less Details";
			// 
			// urlConfigured
			// 
			...
			this.urlConfigured.Text = "Show Default Exception Report";
			// 
			// urlCustomMessage
			// 
			...
			this.urlCustomMessage.Size = new System.Drawing.Size(234, 16);
			this.urlCustomMessage.TabIndex = 5;
			this.urlCustomMessage.TabStop = true;
			this.urlCustomMessage.Text = "Show Custom Message and attach file";
			// 
